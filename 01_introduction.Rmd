...
of this case study is to assist **Cyclistic**, a fictional bike-share 
`r icon_style(fontawesome("bicycle", style = "solid"), scale = 2, fill = "purple") ` company offering rentals in Chicago, IL.  
